...
grid.arrange(p1,nrow=1,sub = textGrob(paste0("Last Update: ",max(raw.data$date),",\nData: Alberta Environment (preliminary, subject to change) "), x=0.5, hjust=0.5, vjust=0,gp=gpar(fontsize=12)))
dev.off()
